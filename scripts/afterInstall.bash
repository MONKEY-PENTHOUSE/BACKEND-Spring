docker pull gmlwls3520/BACKEND-Spring:v1
docker run --env-file /home/ubuntu/.env --publish 80:3000 -i --detach --name stuvel-codedeploy gmlwls3520/BACKEND-Spring:v1
