...
docker create --env-file /home/ec2-user/resources/var.env --publish 80:80 -v /home/ec2-user/log:/home --name api-server-spring -i monkeypenthouse/api-server-spring:v1
